 ...
 * @author Luan
 */
public class TabelaFuncionario extends javax.swing.JFrame implements TableModelListener{
    ...
    public TabelaFuncionario(Funcionario funcionarioLogado){
    ...
    private void preenchendoListaFuncionarios(String nome){
        removendoLinhasTabela();
        List<Funcionario> listaFuncionarios = funcionarioDAO.getFuncionariosNome(nome);
        if(listaFuncionarios != null){
            for(Funcionario funcionario : listaFuncionarios){
                modelo.addRow(new Object[]{funcionario.getIdFuncionario(), funcionario.getNome(), funcionario.getUsuario(), funcionario.getLocadora().getNome()});
            }
        }
    }
     ...
     private void verificacaoInicial(){
        ...
        if(listaFuncionarios != null && listaFuncionarios.size() > 0){
            ...
            JOptionPane.showMessageDialog(null, "Não existem Funcionarios cadastrados."); 
            dispose();
        }
    }
    /**
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        if(selecionada > -1){
            ...
            if(JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir o funcionário selecionado?", "Exclusão", 2)== JOptionPane.OK_OPTION){
            funcionarioDAO.dropFuncionario(id);
                preenchendoListaFuncionarios(tfBusca.getText());
            selecionada = -1;
        }
        }else{
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        if(selecionada > -1){
            ...
            new EditarFuncionario(funcionarioLogado, funcionario).setVisible(true);
            selecionada = -1;
        }else{
            JOptionPane.showMessageDialog(null, "Selecione o funcionário na tabela");
        }
